            ...
            <View style={styles.container}>
                <View style={styles.box}>
                    <View style={styles.split}>
                        <View style={[styles.splitTitleBox, styles.splitTitleBoxLeft, {backgroundColor: colors.yellow}]}>
                    ...
                    <View style={styles.split}>
                        <View style={[styles.splitTitleBox, styles.splitTitleBoxRight, {backgroundColor: colors.yellow}]}>
