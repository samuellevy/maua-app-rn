...
export default class modal extends Component {
    ...
    render() { 
        let backNavigator = this.props.backNavigator;
            ...
            <Modal animationType="fade"    
                ...
                <View style={styles.contentModal}>
                    <View style={styles.wrapper}>
                        ...
                        <Text style={styles.titleModal}>Poxa, tem certeza que deseja sair?</Text>
                        <Text style={styles.textModal}>Seu progresso será salvo e você poderá continuar de onde parou.</Text>

                        <View style={styles.boxBtn}>
                            <TouchableOpacity style={styles.btnExit} onPress={backNavigator}>
                                <Text style={styles.textBtnExit}>SAIR</Text>
                            </TouchableOpacity>

                            <TouchableOpacity style={styles.btnConfirm}  onPress={() => {this.setState({visibleModal: false})} }>
